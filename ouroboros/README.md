...
`joi-lab/ouroboros`(Colab/Telegram)와 `joi-lab/ouroboros-desktop`(Desktop/Web UI)를 중심으로, **자기개선형 AI agent harness** 구조와 운영 패턴을 정리한 문서입니다.
...
| 문서 | 내용 |
|---|---|
| [아키텍처 다이어그램](/ouroboros/00-diagram.md) | Ouroboros 하네스 계층, 태스크 실행 루프, 자기개선 루프, Polysona 플로우 및 호스트 연동 |
| [설계/활용 사례 분석](/ouroboros/01-analysis.md) | 하네스 구성요소, 운영 시나리오, Polysona 코드 구조·명령 체계, 비교 시사점 |
...
- **Ouroboros 하네스**: 태스크 오케스트레이션 + 안전 레이어 + 메모리/리뷰/진화 루프를 통합한 자기개선 실행기
