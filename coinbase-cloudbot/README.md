...
| 문서                                           | 내용                                                    |
|----------------------------------------------|-------------------------------------------------------|
| [아키텍처 다이어그램](/coinbase-cloudbot/00-diagram.md)                | 전체 시스템 흐름, 재구성된 상호작용 패턴, 컨텍스트 파이프라인, 검증 파이프라인         |
| [설계 및 워크플로우 분석](/coinbase-cloudbot/01-cloudbot.md)            | 구축 배경, 핵심 설계 결정, 공개 자료에 반복 등장하는 상호작용 패턴, AI 도입 전략, 성과 |
| [Coinbase AI 에이전트 생태계](/coinbase-cloudbot/02-ai-ecosystem.md) | QA AI Agent, NodeSmith, 피드백-to-PR 파이프라인, 고객 지원 AI     |
