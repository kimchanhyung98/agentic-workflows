...
> **대상 버전**: 2026-04-07 공지된 **v2 재작성판** (Bun + TypeScript). v1(Python 기반 task management + RAG)은 [`archive/v1-task-management-rag`](https://github.com/coleam00/Archon/tree/archive/v1-task-management-rag) 브랜치에 보존되어 있으며 본 문서의 분석 대상이 아닙니다.
