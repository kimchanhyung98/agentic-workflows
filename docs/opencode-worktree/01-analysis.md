...
> 다이어그램: [00-diagram.md § 1](./00-diagram.md#1-모듈-아키텍처-및-초기화)
...
> 다이어그램: [00-diagram.md § 2](./00-diagram.md#2-worktree-생성-파이프라인)
...
> 다이어그램: [00-diagram.md § 3, § 4](./00-diagram.md#3-worktree-삭제-및-지연-삭제-패턴)
...
> 다이어그램: [00-diagram.md § 5](./00-diagram.md#5-크로스-플랫폼-터미널-감지)
...
> 다이어그램: [00-diagram.md § 6](./00-diagram.md#6-임시-스크립트-생명주기)
...
> 다이어그램: [00-diagram.md § 7](./00-diagram.md#7-파일-동기화-전략)
...
> 다이어그램: [00-diagram.md § 8](./00-diagram.md#8-보안-검증-체인)
...
> 다이어그램: [00-diagram.md § 9](./00-diagram.md#9-프로젝트-id-생성-및-캐싱)
...
> 다이어그램: [00-diagram.md § 10](./00-diagram.md#10-데이터-경로-맵)
...
> 다이어그램: [00-diagram.md § 11](./00-diagram.md#11-전체-end-to-end-파이프라인)
