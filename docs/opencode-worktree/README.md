...
| 문서                                    | 내용                                                                   |
|---------------------------------------|----------------------------------------------------------------------|
| [아키텍처 다이어그램](./00-diagram.md)         | 11개 mermaid 다이어그램 — 모듈 구조, 생성/삭제 파이프라인, 터미널 감지, 상태 모델, 보안 체인, E2E 흐름 |
| [설계 및 실행 플로우 상세 분석](./01-analysis.md) | 핵심 설계 결정, 크로스 플랫폼 전략, 보안 다층 방어, 설정 시스템, 강점/트레이드오프                    |
