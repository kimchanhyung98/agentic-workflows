...
아래 파일은 조사 과정에서 작성된 원본 자료이다. 최종 문서의 근거와 출처 추적에 활용할 수 있다.

| 파일                                                                   | 내용                                      |
|----------------------------------------------------------------------|-----------------------------------------|
| [coinbase-cloudbot-research.md](./coinbase-cloudbot-research.md)     | 웹 검색 기반 상세 조사 (수치, 아키텍처, 성과, 신뢰도 평가 포함) |
| [coinbase-cloudbot-research-2.md](./coinbase-cloudbot-research-2.md) | 출처 신뢰도 심층 검증 (공식/공개 발언/2차 정리 분류)        |

---

## Cloudbot 개요

공개 자료를 종합하면, Cloudbot은 Slack와 Linear를 중심으로 PR 작성과 이슈 분석을 자동화하는 Coinbase 내부 코딩/백그라운드 에이전트로 보인다.
