...
[Google Cloud - Choose a design pattern for an agentic AI system](https://cloud.google.com/architecture/choose-design-pattern-agentic-ai-system) 을 기반으로 작성되었습니다.
