...
인간 참여형 패턴은 에이전트 워크플로에 인간의 개입 지점을 직접 통합하는 패턴입니다. 미리 정의된 체크포인트에서 에이전트의 실행을 일시 중지하고, 외부 시스템을 통해 사람의 검토를 기다린 후, 승인/수정/입력을 받아 실행을 재개합니다.
