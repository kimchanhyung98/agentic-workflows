...
| [Reflexion: Language Agents with Verbal Reinforcement Learning](https://arxiv.org/abs/2303.11366) | Shinn et al. (NeurIPS 2023) | 자기 반성 메모리를 통한 에이전트 성능 개선 |
...
| [Agentic Concepts](https://langchain-ai.github.io/langgraph/concepts/agentic_concepts/) | LangGraph | 에이전트 루프, 도구 호출, 메모리 관리 |
| [AI Agents in LangGraph](https://python.langchain.com/docs/concepts/agents/) | LangChain | 에이전트 구현 가이드 |
