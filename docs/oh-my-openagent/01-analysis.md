...
매니저 생성 후 **기본 설정 기준 26개 도구**가 등록됩니다. 실제 등록 수는 `task_system`, `hashline_edit` 등 옵션 활성화 여부에 따라 달라집니다.

### 2.4 훅 생성

도구 등록 후 **기본 설정 기준 46개 훅**이 생성됩니다. `isHookEnabled` 설정에 따라 실제 활성화되는 훅 수는 달라질 수 있습니다.
