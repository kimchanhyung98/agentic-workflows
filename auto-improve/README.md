...
> 사람은 **무엇을, 어떤 규칙으로** 개선할지 정의하고, AI가 **어떻게** 개선할지 스스로 실험하고, 측정하고, 유지하거나 폐기함.

## 개요

Auto Improve Loop는 AI 에이전트가 자율적으로 코드를 수정하고, 실험하고, 결과를 측정하여 개선 여부를 판단하는 반복 루프임.
[karpathy/autoresearch](https://github.com/karpathy/autoresearch)의 핵심 아이디어를 기반으로,
사람이 목표와 운영 규칙(program.md)을 작성하면 AI가 나머지를 수행하는 구조를 정리함.
